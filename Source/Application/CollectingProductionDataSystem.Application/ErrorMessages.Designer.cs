...
namespace App_Resources {
    ...
    public class ErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Daily data for {0} and process unit {2} are not approved ..
        /// </summary>
        public static string DailyNotReady {
            get {
                return ResourceManager.GetString("DailyNotReady", resourceCulture);
            }
        }
