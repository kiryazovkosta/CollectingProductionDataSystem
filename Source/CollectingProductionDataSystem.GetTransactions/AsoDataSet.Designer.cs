    ...
    public partial class flow_MeasuringPointsDataTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        SequenceNumber, ExciseStoreId, ZoneId, MeasuringPointId, Transactio" +
                ...
                "ntsData\r\nWHERE        (SequenceNumber > @MaximumLastFetchSequenceNumber)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MaximumLastFetchSequenceNumber", global::System.Data.SqlDbType.BigInt, 8, global::System.Data.ParameterDirection.Input, 0, 0, "SequenceNumber", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(AsoDataSet.flow_MeasuringPointsDataDataTable dataTable, long MaximumLastFetchSequenceNumber) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((long)(MaximumLastFetchSequenceNumber));
        ...
        public virtual AsoDataSet.flow_MeasuringPointsDataDataTable GetData(long MaximumLastFetchSequenceNumber) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((long)(MaximumLastFetchSequenceNumber));
