namespace CollectingProductionDataSystem.MathExpr.Test
{
    ...
    public class FormulasTests
    {
        ...
        public void PartFormulaA2()
        {
            ...
            double d = 50;
            double al = 0.001163;
            df = Functions.GetValueFormulaC(t, d, al);
        ...
        public void PartFormulaEN()
        {
            ...
            double k2 = 0;
            double k3 = 0;
            k15 = Functions.GetValueFormulaK15(t, p);
            k2 = Functions.GetValueFormulaK2(t, p);
            k3 = Functions.GetValueFormulaK3(t);
