namespace CollectingProductionDataSystem.Web.Areas.MonthlyDataReporting.Controllers
{
    ...
    [Authorize(Roles = "Administrator, MonthlyAirReporter, SummaryReporter")]
    public class MonthlyAirController : BaseMonthlyController
    {
        public MonthlyAirController(IProductionData dataParam, IUnitMothlyDataService monthlyServiceParam)
        ...
        protected override MonthlyReportParametersViewModel GetReportParameters()
        {
            return new MonthlyReportParametersViewModel(
                    reportName: Resources.Layout.UnitMonthlyAirData,
                    controllerName: "MonthlyAir",
                    monthlyReportTypeId: CommonConstants.Air,
