...
namespace CollectingProductionDataSystem.Web.Infrastructure.CustomLogEvents
{
    public class CustomExceptionEvent : System.Web.Management.WebRequestEvent
    {
        ...
        public CustomExceptionEvent(String msg, Object eventSource, Int32 eventCode)
        ...
        public CustomExceptionEvent(String msg, Object eventSource, Int32 eventCode, Int32 eventDetailCode)
